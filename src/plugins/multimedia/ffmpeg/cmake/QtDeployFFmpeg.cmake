...
function(qt_internal_multimedia_copy_or_install_ffmpeg)
    ...
    if (UIKIT)
        ...
        foreach(lib_path ${FFMPEG_SHARED_LIBRARIES})
            ...
            if (EXISTS "${path}/../framework/${lib_name_we}.framework")
                list(APPEND ffmpeg_frameworks "${path}/../framework/${lib_name_we}.framework")
            else()
                message(WARNING "${path}/../framework/${lib_name_we}.framework does not exist")
            endif()
        endforeach()
